...
<div class="group">
  ...
  <label for="nombre">Nombre <span></span></label><div></div>
      ...
      <input type="text" name="rut" class="form-input" required/> <br> <img src="images/2016-06-08.png" style="float: right"/> </right>
      ...
      <br>
      <br>
      <right> <input class="form-btn" name="registrarse" type="submit" value="Suscribirse"/></right>
